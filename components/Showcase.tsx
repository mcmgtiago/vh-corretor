...
import { FadeUp, StaggerContainer, StaggerItem, GradientBlob } from "@/components/Animations"
  ...
  return (
    <section className="relative bg-white py-20 lg:py-28">
      ...
      <div className="relative mx-auto max-w-[1200px] px-8 lg:px-10">
        ...
        {/* Grid — 3 columns */}
        <StaggerContainer className="mt-10 grid gap-5 lg:grid-cols-[1fr_0.8fr_1fr]">
          {/* Card 1 — Large image */}
          <StaggerItem>
          ...
          {/* Card 2 — Text card */}
          <StaggerItem>
            <div className="flex h-full flex-col items-center justify-center rounded-2xl border border-gray-200 px-8 py-10 text-center">
